...
META = scipy.io.loadmat("data/ILSVRC2012_devkit_t12/data/meta.mat")
...
if __name__ == '__main__':
    generate_image_folder_format(folder_path = "data/ILSVRC2012_img_val", 
                                annotations_path = "data/ILSVRC2012_devkit_t12/data/ILSVRC2012_validation_ground_truth.txt",
